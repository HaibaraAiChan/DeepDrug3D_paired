...
def worker(pro_list,aux_filename_list,args):
...
if __name__ == "__main__":
    ...
    for i in range(P_NUM):
   	p.apply_async(worker,args=(protein_list[size/P_NUM * i: size/P_NUM * (i+1)],aux_filename_list,args,)) 
    p.close()
    p.join()
